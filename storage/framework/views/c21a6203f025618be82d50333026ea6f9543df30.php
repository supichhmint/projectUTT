...
<head>
    ...
    <!-- Custom Fonts -->
            ...
            <?php echo e(Html::style('css/shop-homepage.css')); ?>
...
<?php endif; ?>
    ...
    <?php if(Auth::guest()): ?>
        <li class="fl"><a href="<?php echo e(route('login')); ?>">เข้าสู่ระบบ</a></li>
        <li class="fl"><a href="<?php echo e(route('register')); ?>">สมัครสมาชิก</a></li>
    <?php else: ?>
                        ...
                        <div class="donate-box-content">
                          ...
                          <ul class="bank-list">
                            <li class="bank-list-item">
                              <div class="paytype">
                                  <img src="<?php echo e(url('/images/logos/ayud.png')); ?>" alt="" />
                              </div>
                              <div class="payname">ธนาคารกรุงศรี</div>
                            </li>
                            <li class="bank-list-item">
                              <div class="paytype">
                                  <img src="<?php echo e(url('/images/logos/bkk.png')); ?>" alt="" />
                              </div>
                              <div class="payname">ธนาคารกรุงเทพ</div>
                            </li>
                            <li class="bank-list-item">
                              <div class="paytype">
                                  <img src="<?php echo e(url('/images/logos/ktb.png')); ?>" alt="" />
                              </div>
                              <div class="payname">ธนาคารกรุงไทย</div>
                            </li>
                            <li class="bank-list-item">
                              <div class="paytype">
                                  <img src="<?php echo e(url('/images/logos/scb.png')); ?>" alt="" />
                              </div>
  ...
  $('ul.bank-list li').click(function(e)
    {
     ...
     switch (bankName) {
       case 'ธนาคารกรุงศรี':
         ...
         bankLogo = '<?php echo e(url('/images/logos/ayud.png')); ?>'
         break;
       case 'ธนาคารกรุงเทพ':
         bankCode = 'internet_banking_bbl'
         bankLogo = '<?php echo e(url('/images/logos/bkk.png')); ?>'
         break;
       case 'ธนาคารกรุงไทย':
         bankCode = 'internet_banking_ktb'
         bankLogo = '<?php echo e(url('/images/logos/ktb.png')); ?>'
         break;
       case 'ธนาคารไทยพาณิชย์':
         bankCode = 'internet_banking_scb'
         bankLogo = '<?php echo e(url('/images/logos/scb.png')); ?>'
         break;
       default:
          bankCode = null
     }
