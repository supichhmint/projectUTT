        ...
        <div class="col-md-5">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4><i class="fa fa-fw fa-gift"></i><?php echo e($trip->start_date); ?> - <?php echo e($trip->departure_date); ?>  </h4>
                </div>
                ...
                <table class="table">
                    <tr>
                        ...
                        <td><?php echo e($trip->trips_name); ?></td>
                    </tr>
                    <tr>
                        <td>ที่นั้งทั้งหมด</td>
                        <td><?php echo e($trip->amount_seats); ?> </td>
                    </tr>
                    <tr>
                        <td>TOTAL</td>
                        <td>0</td>
