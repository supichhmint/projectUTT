  ...
  <div class="welcome about" style="padding-top:90px;">
    <div class="container" align="center">
      <div class="row">
        ...
        <div>
          <h1><?php echo e($trips->trips_name); ?></h1>
          <p><?php echo e($trips->trip_nday); ?>วัน <?php echo e($trips->trip_nnight); ?>คืน</p>
              ...
              <?php
                ...
                <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                 ...
                 <input type="hidden" name="book_id" value="<?php echo e($bookId); ?>">
                  รอบวันที่ <?php echo e(date('d-m-Y', strtotime($triprounds->start_date))); ?> ถึง <?php echo e(date('d-m-Y', strtotime($triprounds->departure_date))); ?>
